...
urlpatterns = [
    ...
    path('<int:caso_pk>/add_tarefa/', views.add_tarefa, name='add_tarefa'),
    ...
    # AÇÕES EM OBJETOS ESPECÍFICOS (TAREFA, TIMESHEET)
    path('tarefa/<int:tarefa_pk>/concluir/', views.concluir_tarefa, name='concluir_tarefa'),
    path('tarefa/<int:tarefa_pk>/reabrir/', views.reabrir_tarefa, name='reabrir_tarefa'),
    path('tarefa/<int:tarefa_pk>/deletar/', views.deletar_tarefa, name='deletar_tarefa'),
    path('timesheet/<int:ts_pk>/delete/', views.delete_timesheet, name='delete_timesheet'),
    path('timesheet/<int:pk>/editar/', views.TimesheetUpdateView.as_view(), name='timesheet_update'),
    ...
    path('webhooks/microsoft-graph/', views.microsoft_graph_webhook, name='microsoft_graph_webhook'),
]