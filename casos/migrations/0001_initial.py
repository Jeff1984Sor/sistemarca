    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advogado_responsavel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casos_responsavel', to='casos.advogado', verbose_name='Advogado Responsável')),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='clientes.cliente')),
                ('etapa_atual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casos_nesta_etapa', to='casos.etapafluxo')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prazo_dias', models.PositiveIntegerField(default=0, help_text='Número de dias para concluir a tarefa após sua criação. 0 para sem prazo.', verbose_name='Prazo (em dias)')),
                ('tipo_prazo', models.CharField(choices=[('corridos', 'Dias Corridos'), ('uteis', 'Dias Úteis')], default='uteis', max_length=10, verbose_name='Tipo de Prazo')),
                ('tipo_responsavel', models.CharField(choices=[('CRIADOR_ACAO', 'Usuário que Concluiu a Ação Anterior'), ('RESPONSAVEL_CASO', 'Responsável Pelo Caso'), ('USUARIO_FIXO', 'Usuário Fixo (especificar abaixo)')], default='CRIADOR_ACAO', max_length=20, verbose_name='Atribuir Responsável Para')),
                ('responsavel_fixo', models.ForeignKey(blank=True, help_text="Usado apenas se o tipo acima for 'Usuário Fixo'.", null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Usuário Fixo')),
